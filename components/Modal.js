...
//                         <button type="button" ref={(element) => {closeButton = element}}className="btn btn-secondary" data-dismiss="modal">Close</button>
//                         {
//                             hasSubmit && <button type="button" onClick={submitModal} className="btn btn-primary">Save changes</button>
//                         }
//                     </div>
//                     </div>
//                 </div>
